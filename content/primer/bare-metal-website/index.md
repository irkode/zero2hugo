...
I just want to get my homepage generated, so I choose the most descriptive name form
[Template lookup order - HomePage](https://gohugo.io/templates/lookup-order/#home-page). I want to
generate HTML, so my homepage template will be `/layouts/home.html`
...
-  and preview the site by browsing _[http://localhost:1313](http://localhost:1313)_
