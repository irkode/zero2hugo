...
Here we will create a _Bare Metal Website_ website from a Markdown content file generated by Hugo.

This is just a starter to get us running with a warm welcome to _Hugo_. We know that this is _bare
metal_ stuff and lacks proper Hugo configuration and conventions. We will deal with that in the
following chapters.

<!--more-->

[Hugo Quick start](https://gohugo.io/getting-started/quick-start/) allows you to set up a siteq
uickly containing some sample content and a theme (if you like - if you don't it will be far from
working).
...
files. In my case - generating html - I have to wrap the content in some html tags to form a valid
HTML5 file:
...
Voila one page generated and checking out the `/public` folder I find:
...
*  and preview the site by browsing _http://localhost:1313_
...
major Browsers add their default styles to at least get some basic structured layout. The directory
structure is rendered with a Markdown fenced code block and by default the renderer adds some
styling for that.
